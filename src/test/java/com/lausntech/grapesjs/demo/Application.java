 ...
 * <p>
 * Vaadin 25 no longer auto-selects a theme once an {@link AppShellConfigurator}
 * is present, so the Aura stylesheet &mdash; which {@link com.lausntech.grapesjs.GrapesJsEditor}'s
 * own chrome depends on for its {@code --aura-*}/{@code --vaadin-*} design
 * tokens &mdash; is loaded explicitly here.
 *
